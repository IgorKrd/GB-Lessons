...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] array1;
        array1 = SomeThingForTestingOne.TakeawayAfterFour(new int[]{1, 2, 4, 4, 2, 3, 4, 1, 7});
        ...
        System.out.println(SomeThingForTestingTwo.isArrayWithoutOneOrFour(new int[] {1, 1, 1, 4, 4}));
